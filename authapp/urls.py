...
from .views import edit, dashboard, register, about
...
urlpatterns = [
    ...
    path('about/', about, name="about"), # écran acceuil application chat documentaire
    ...
    path('password_change/dond/', PasswordChangeDoneView.as_view(template_name='authapp/password_change_done.html'), name='password_change_done'),
